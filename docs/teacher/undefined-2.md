...
* 원아워는 AI 기반 문제 생성 서비스로, 일부 문항에서 드물게 오류가 발생할 수 있습니다.
* 내부적으로 품질 개선을 지속하고 있으며, 오류 발생 시 선생님께서 문제 또는 정답을 직접 수정해 바로 활용하실 수 있습니다.

#### II. 영상 보며 따라하기

{% embed url="https://youtu.be/D_cfB1SSQnE" %}
...
3. **"수정이 필요한 문제"에서 변경하실 선택지를 찾아 수정해주시면 됩니다.**
