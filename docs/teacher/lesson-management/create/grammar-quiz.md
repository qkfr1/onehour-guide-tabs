...
{% stepper %}
{% step %}
\[수업 생성] 버튼 클릭 후 수업이 자동으로 생성됩니다.
{% endstep %}

{% step %}
생성된 수업의 문제 구성과 내용을 검토합니다.
{% endstep %}

{% step %}
필요한 경우 수업 제목이나 세부 설정을 수정한 뒤 저장하거나 학생에게 배포합니다.
{% endstep %}
{% endstepper %}
...
생성된 문법 수업은 검토 후 즉시 과제로 배포할 수 있습니다. 저장해 두었다가 나중에 배포하는 것도 가능합니다.
{% endhint %}
