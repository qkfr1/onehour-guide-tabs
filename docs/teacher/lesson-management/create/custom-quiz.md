...
수업에 들어갈 문제를 직접 만들고 편집하는 방법을 안내합니다. 객관식과 주관식 모두 만들 수 있고, 문제마다 음원이나 이미지 파일을 붙일 수 있습니다.

{% hint style="info" %}
문제를 직접 입력해 만드는 방법입니다. **AI로 문제 세트 생성**은 크레딧이 차감됩니다.
{% endhint %}

## 영상보며 따라하기

{% embed url="https://youtu.be/7qjGeK-ehbs" %}

## 1. 문제 생성 화면 들어가기

### 방법 1. 이미 만들어 둔 수업에 문제 추가하기
...
문제는 세트 단위로 관리합니다. 먼저 문제를 담을 세트를 만듭니다.
...
세 항목 모두 선택 입력이며 각각 4,000자까지 입력할 수 있습니다. 해설은 학생이 문제를 모두 풀고 나면 볼 수 있습니다.
{% endstep %}
...
{% step %}
문제를 모두 풀면 **학습 결과**에서 정답률과 오답을 확인합니다.

리포트는 **과제 관리 > 리포트 > 연습 탭**에서 확인할 수 있습니다.
{% endstep %}
{% endstepper %}
...
<summary>문제를 직접 만들 때도 크레딧이 차감되나요?</summary>

직접 입력해 만드는 경우에는 차감되지 않습니다. **AI로 문제 세트 생성**을 이용할 때만 크레딧이 차감됩니다.

</details>

<details>

<summary>복수 정답으로 낼 수 있나요?</summary>

가능합니다. 정답인 선택지의 체크박스를 모두 체크하면 됩니다.

</details>

<details>

<summary>듣기 문제를 만들고 싶어요.</summary>

문제의 **본문** 아래 **파일 첨부 1**에 음원 파일을 첨부하면 학습 화면에서 음원이 재생됩니다.

</details>

<details>

<summary>삭제한 문제 세트를 되돌릴 수 있나요?</summary>

되돌릴 수 없습니다. 삭제한 문제 세트는 복구되지 않으니 확인 후 삭제해 주세요.
