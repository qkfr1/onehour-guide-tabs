...
매월 1일부터 오늘까지 부여된 과제를 기준으로 계산되며, 클래스 페이지와 과제관리에서 한눈에 확인할 수 있습니다.
...
클래스 페이지 또는 과제관리 좌측 학생 목록에서 각 학생 이름 옆에 과제 완료율이 표시됩니다.
...
과제관리에서 학생을 선택하면 월간 과제 완료율과 영역별(콘텐츠·단어·문장·말하기·문제·쓰기) 완료율을 확인할 수 있습니다.
