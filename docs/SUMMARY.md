...
* [수업 관리](faq/lesson-management/README.md)
  * [중고등 내신대비 수업 생성](faq/lesson-management/undefined/README.md)
    * [iii. 기출문제 바탕 → 킬러 문항 대비](faq/lesson-management/undefined/q01.md)
    * [iv. 정답 오류 → 즉시 수정하기](faq/lesson-management/undefined/q02.md)
    * [v. 변형문제 생성 → 파이널 시험지 랜덤 인쇄](faq/lesson-management/undefined/q03.md)
    * [vi. 파이널 문제풀이 → 시험 모드](faq/lesson-management/undefined/q05.md)
    * [vii. 프롬프트 입력 → 타겟 문법 학습](faq/lesson-management/undefined/q06.md)
    * [ii. 본문 입력  → 변형문제 생성](faq/lesson-management/undefined/bm.md)
  ...
  * [자동 생성된 문제 세트 이름 수정하는 법](faq/lesson-management/q05-1.md)
  * [영어 지문 또는 단어장(PDF/엑셀)을 통해 단어 테스트 만드는 법](faq/lesson-management/q08.md)
  * [오프라인 시험지를 온라인으로 옮겨서 자산화할 수 있나요? 아이들에게 해당 시험 오답을 반복적으로 풀도록 할 수 있나요?](faq/lesson-management/q08-1.md)
...
* [과제 관리](faq/assignment-management/README.md)
  ...
  * [책과제를 반복으로 내고 싶어요](faq/assignment-management/undefined.md)
